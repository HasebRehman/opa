      ...
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-7">
            ...
            {/* Menu item with Hover Dropdown (Unclickable parent text) */}
            <div className="relative group py-2">
              <span
                className={`text-[13px] font-semibold tracking-wide flex items-center gap-1 cursor-default select-none transition-colors group-hover:text-mint ${
              ...
              <div className="absolute top-full left-0 hidden group-hover:block pt-2 z-50 animate-in fade-in duration-150">
                <div className="bg-white rounded-xl shadow-2xl border border-gray-100 py-2 px-1 min-w-[260px] space-y-1">
                  <button
                    ...
                    className="w-full text-left px-4 py-2.5 text-xs font-semibold text-charcoal hover:bg-mint/10 hover:text-mint rounded-lg transition-colors cursor-pointer block"
                  >
                    Restaurant Menu
                  </button>
                  <button
            ...
            <Link
              href="/private-room"
              className={`text-[13px] font-semibold tracking-wide transition-colors hover:text-mint cursor-pointer ${
                useWhiteHeader ? 'text-charcoal' : 'text-white'
              }`}
            >
              Private Room
          ...
          <div className="flex items-center gap-4">
            ...
            <div className={`hidden lg:flex items-center gap-3 ${useWhiteHeader ? 'text-charcoal' : 'text-white'}`}>
              <a
